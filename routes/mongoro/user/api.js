    ...
    try {
        ...
        if (user) {
                                        ...
                                        <tr>
                                            <td>
                                                <table width=100%>
                                                    <tr>
                                                        <td>
                                                            <h3 class="header" style='color: #161616'>Verification code</h3>
                                                            <p style='margin:2rem 0; color: #161616; line-height: 1.5rem;'>
                                                                 To delete your account, please verify is your account by entering the code below .
                                                                <br>
            ...
            MongoroUserModel.updateOne({ _id: req.body.userId }, { $set: { note: req.body.note ,  reason: req.body.reason} }).then(async () => {
                return res.status(200).json({
                    msg: 'complete the 2FA verification to complete the deletio of account',
                    code,
                    status: 200
                })
            })
