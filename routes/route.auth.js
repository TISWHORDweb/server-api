...
const { userRegister, userVerify, userVerified, userLogin, userPasswordVerify, userSettings, userEmailVerify, updatePassword, resetPassword } = require('../controller/controller.auth');
