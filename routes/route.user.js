...
const { generateCoupon, singlecoupon, allcoupon, deletecoupon, assigncoupon,stripePayment, cancelCoupon, companyCoupons, updateCoupons, activeCompanyCoupons, companyCouponSummary } = require('../controller/controller.coupon');
